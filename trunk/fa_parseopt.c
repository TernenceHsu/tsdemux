...
const char *usage =
"\n\n"
"Usage: tsdemux <-i> <inputfile> <-v> <video_outputfile> [options] \n"
"       tsdemux <-i> <inputfile> <-a> <audio_outputfile> [options] \n"
"       tsdemux <-i> <inputfile> <-v> <video_outputfile> <-a> <audio_outputfile> [options] \n"
"\n\n"
"See also:\n"
